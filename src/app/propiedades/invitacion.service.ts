...
generarInvitacion(token: string,correo_electronico: string, id_fraccionamiento: number,nombre_fraccionamiento:string,nombre_admin:string,tipo_usuario:string) {
  console.log("invitacionservice");
  return this.http.post(`${this.apiUrl}/Generar_invitacion?token=${token}&correo_invitado=${correo_electronico}&id_fraccionamiento=${id_fraccionamiento}&nombre_fraccionamiento=${nombre_fraccionamiento}&nombre_admin=${nombre_admin}&tipo_usuario=${tipo_usuario}`,{}, { responseType: 'text' });
}
