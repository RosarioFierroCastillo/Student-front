...
export class AgregarUsuarioComponent {
  ...
  paginador_adelante() {
    ...
    disable(usuario: any) {
      ...
      return this.http.get("http://159.54.141.160/api/Usuario_lote/RestrictedUser?id_usuario=" + this.id_fracc).subscribe(
        () => {
    ...
    delete (usuario: any) {
      ...
      return this.http.delete("http://159.54.141.160/api/Usuario_lote/Eliminar_inquilino?id_persona=" + this.id_fracc).subscribe(
        () => {
    ...
    enable(usuario: any) {
      ...
      return this.http.get("http://159.54.141.160/api/Usuario_lote/EnableUser?id_usuario=" + this.id_fracc).subscribe(
        () => {
          Swal.fire({
